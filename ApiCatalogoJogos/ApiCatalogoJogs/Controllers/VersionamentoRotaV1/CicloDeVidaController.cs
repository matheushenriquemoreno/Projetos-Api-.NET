...
{
    [Route("api/[controller]")]  // url /api/CicloDeVida
    [ApiController]
    public class CicloDeVidaController : ControllerBase
    {
        public readonly IExemploSingleton _exemploSingleton1; // Quando a plicação sobre ele cria uma instancia da classe e ele fica pra sempre 
        public readonly IExemploSingleton _exemploSingleton2; // fa

        public readonly IExemploScoped _exemploScoped1; // uma instancia que fica por toda aplicação
        public readonly IExemploScoped _exemploScoped2;

        public readonly IExemploTransient _exemploTransient1; // cada vez que e chamado ele gera uma nova instancia nova 
